 ...
 */
package br.ufsm.Camadas.ui;
import br.ufsm.Camadas.negocio.LivrosNegocio;
...
public class LivroUI extends javax.swing.JFrame {
    private LivrosNegocio cadastroNegocio = new LivrosNegocio();
    /**
    ...
    private void jB_CadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_CadastrarActionPerformed
        ...
        cadastroNegocio.inserirDados(jTF_Titulo.getText(), jTF_Autor.getText());
        jTF_Titulo.setText("");
        jTF_Autor.setText("");
    ...
    private void jB_ListarLivrosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_ListarLivrosActionPerformed
        ...
        LivrosDados db = cadastroNegocio.getDados();
        
        for(int i=0; i<db.getNumElementoInseridos(); i++){
            jTA_ListarLivros.append(db.getTitulo(i)+" | "+db.getAutor(i)+"\n");
        }
